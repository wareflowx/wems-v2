...
export const settings = sqliteTable("settings", {
  ...
  // Alerts
  cacesAlerts: integer("caces_alerts", { mode: "boolean" })
    .notNull()
    .default(true),
  cacesDays: integer("caces_days").notNull().default(30),
  medicalAlerts: integer("medical_alerts", { mode: "boolean" })
    .notNull()
    .default(true),
  medicalDays: integer("medical_days").notNull().default(7),
  contractAlerts: integer("contract_alerts", { mode: "boolean" })
    .notNull()
    .default(false),
  ...
  readOnlyMode: integer("read_only_mode", { mode: "boolean" })
    .notNull()
    .default(false),
